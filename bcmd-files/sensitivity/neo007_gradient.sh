...
do
    ...
    # DATASET="neo007"
    OUTDIR1=`readlink -m "../../data/SA_results/gradient/${DATASET}"`
    OUTDIR2=`readlink -m "../../data/SA_results/gradient/${DATASET}_zero"`
    
    WORKDIR=$1
    # JOBFILE1="${WORKDIR}${DATASET}_SA.dsimjob"
    JOBFILE2="${WORKDIR}${DATASET}_gradient_SA_zero.dsimjob"
